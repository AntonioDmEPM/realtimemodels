...
DROP FUNCTION IF EXISTS public.search_similar_chunks(vector, uuid, double precision, integer);

-- Recreate the function with user_id parameter for ownership validation
